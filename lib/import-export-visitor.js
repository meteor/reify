    ...
    if (
      ...
      if (this.magicString !== null) {
        if (this.wrapForTopLevelAwait) {
          this.magicString.prepend('!module.wrapAsync(async function (' + this.moduleAlias + ', __reifyWaitForDeps__, __reify_async_result__) {');
          this.magicString.append(`//*/\n__reify_async_result__();}, { self: this, async: ${this.hasTopLevelAwait} });`);
        } else {
